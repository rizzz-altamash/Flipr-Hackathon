...
// const AlertCard = ({ type, title, message, count, color }) => (
//   <motion.div
//     whileHover={{ scale: 1.02 }}
//     className={`bg-white rounded-xl border-l-4 border-${color}-500 p-4 shadow-sm hover:shadow-md transition-all duration-200`}
//   >
//     <div className="flex items-center">
//       <div className={`p-2 rounded-lg bg-${color}-100`}>
//         <ExclamationTriangleIcon className={`h-5 w-5 text-${color}-600`} />
//       </div>
      ...
      <div className="space-y-4 lg:space-y-6">
        ...
        <div className="flex flex-col space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0">
          ...
          <div className="flex space-x-2 lg:space-x-3">
            ...
            <motion.button
              whileTap={{ scale: 0.95 }}
              className="flex-1 lg:flex-none bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 rounded-lg font-medium text-sm shadow-lg hover:shadow-xl transition-all duration-200"
            >
              Export
            </motion.button>
          </div>
